...
extension WidgetTesterExtensions on WidgetTester {
  ...
  Future<void> scrollUntilVisibleByKeys(ValueKey<String> scrollViewKey, ValueKey<String> widgetKey) async {
  ...
  Future<void> _performActionByKeyAndSettle(Finder finder, Future<void> Function(Finder finder) action) async {
  ...
  Finder _scrollableFinder(ValueKey<String> scrollViewKey) {
    return find.byWidget(
      find
          ...
          .evaluate()
          .where((e) => (e.widget as Scrollable).axisDirection == AxisDirection.down)
          .first
          .widget,
    );
  }
